...
## - overview
Thanks for providing the nm subject. Based on the given instructions, here's an updated overview and guidelines to complete the project:

Set up your environment: Since you have to work with ELF binaries, make sure to use a Linux docker/VM for development.
